...
const attachmentSlotTabsClassName = 'pointer-events-auto -mt-3 mb-[5px] max-w-max rounded-full bg-[color-mix(in_oklch,var(--surface-container-lowest)_88%,transparent)] p-[3px] shadow-sm'
