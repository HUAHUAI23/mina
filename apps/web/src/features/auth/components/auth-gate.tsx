...
export function AuthGate({ children }: PropsWithChildren) {
  ...
  return (
    <div className="mina-auth-locked">
      <div className="mina-auth-underlay" aria-hidden="true">
        {children}
      </div>
      <div className="mina-auth-overlay">
        <section
          className="mina-auth-card"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <section className="mina-auth-panel">
            <div className="mina-auth-heading">
              ...
              <h1 id="mina-auth-title">{mode === 'login' ? 'Sign in to MINA' : 'Start with MINA'}</h1>
            </div>
