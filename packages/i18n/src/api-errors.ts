...
export const apiErrorMessageKeys = [
  ...
  'api_error_account_avatar_not_found',
  ...
  'api_error_media_object_not_ready',
  'api_error_media_object_not_uploading',
  'api_error_media_upload_key_mismatch',
  'api_error_chat_thread_not_found',
  'api_error_chat_message_empty',
  'api_error_chat_attachment_not_ready',
  'api_error_chat_attachment_invalid',
  'api_error_chat_assistant_message_not_retryable',
...
const apiErrorMessageByKey = {
  ...
  api_error_account_avatar_not_found: m.api_error_account_avatar_not_found,
  ...
  api_error_media_object_not_ready: m.api_error_media_object_not_ready,
  ...
  api_error_chat_thread_not_found: m.api_error_chat_thread_not_found,
  api_error_chat_message_empty: m.api_error_chat_message_empty,
  api_error_chat_attachment_not_ready: m.api_error_chat_attachment_not_ready,
  api_error_chat_attachment_invalid: m.api_error_chat_attachment_invalid,
  api_error_chat_assistant_message_not_retryable: m.api_error_chat_assistant_message_not_retryable,
...
export const apiErrorMessageKeyByCode = {
  ...
  ACCOUNT_AVATAR_NOT_FOUND: 'api_error_account_avatar_not_found',
  ...
  MEDIA_OBJECT_NOT_READY: 'api_error_media_object_not_ready',
  ...
  CHAT_ATTACHMENT_NOT_READY: 'api_error_chat_attachment_not_ready',
  CHAT_ATTACHMENT_PURPOSE_INVALID: 'api_error_chat_attachment_invalid',
  CHAT_ATTACHMENT_TYPE_INVALID: 'api_error_chat_attachment_invalid',
  CHAT_MESSAGE_EMPTY: 'api_error_chat_message_empty',
  CHAT_ASSISTANT_MESSAGE_NOT_RETRYABLE: 'api_error_chat_assistant_message_not_retryable',
  CHAT_THREAD_NOT_FOUND: 'api_error_chat_thread_not_found',
