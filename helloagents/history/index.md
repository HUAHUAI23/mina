...
| 2026-05-21 | Workflow Yjs SSOT storage refactor | Complete | Removed frontend autosave/checkpoint, deleted the editable SQL graph read-model from active schema/services, made Yjs snapshots/update logs the editable graph source of truth, and kept workflow execution on immutable run snapshot tables. |
